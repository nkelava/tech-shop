...
namespace TechStore.Infrastructure.Migrations
{
    ...
    [Migration("20230820014841_ProductAttributeSet")]
    partial class ProductAttributeSet
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechStore.Domain.Entities.OrderAggregate.Order", b =>
                {
                    b.HasOne("TechStore.Domain.Entities.OrderAggregate.DeliveryAddress", "DeliveryAddress")
                        .WithOne("Order")
                        .HasForeignKey("TechStore.Domain.Entities.OrderAggregate.Order", "DeliveryAddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
